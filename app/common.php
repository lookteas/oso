<?php
// +----------------------------------------------------------------------
// | jiqu [ WE CAN DO IT MORE SIMPLE ]
// +----------------------------------------------------------------------
// | Copyright (c) 2017 http://play.news18a.com All rights reserved.
// +----------------------------------------------------------------------
// | Author: news18a 
// +----------------------------------------------------------------------
use think\Db;
...
function export2excel($table, $file = '', $fields = '', $field_titles = '', $tag = '')
{
    ...
    /*设置excel的属性*/
    $objPHPExcel->getProperties()->setCreator("news18a")//创建人
    ->setLastModifiedBy("news18a")//最后修改人
